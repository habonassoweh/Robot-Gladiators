...
var fightOrSkip = function () {
  ...
  if (promptFight === "skip" || promptFight === "SKIP") {
    ...
    if (confirmSkip) {
      ...
      //return if player wants to leace
      return true;
    }
  }
  return false;
...
var startGame = function () {
  ...
  for (var i = 0; i < enemyInfo.length; i++) {
    ...
    //if player is not alve, break out of the loop and let endGame function run
    else {
  ...
  // after the loop ends, player is either out of healh or enemies to fight, so run the endGame function
